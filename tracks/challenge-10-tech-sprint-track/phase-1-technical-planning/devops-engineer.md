...
7. **Write user stories** -- Create 2-3 GitHub Issues for infrastructure work (devcontainer setup, CI pipeline, environment configuration). Use the template in `challenges/challenge-10-tech-sprint/templates/user-story-issue.md`.
