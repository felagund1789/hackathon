...
5. **Write user stories** -- Create 3-5 GitHub Issues for the Trails and Condition Reports epics. Use the template in `challenges/challenge-10-tech-sprint/templates/user-story-issue.md`.
