...
6. **Write user stories** -- Create 3-5 GitHub Issues for the frontend-facing features (trail browsing, condition report submission, navigation). Use the template in `challenges/challenge-10-tech-sprint/templates/user-story-issue.md`.
