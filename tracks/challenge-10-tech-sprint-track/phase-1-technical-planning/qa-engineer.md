...
6. **Write user stories** -- Create 2-3 GitHub Issues for QA-specific work (test framework setup, E2E test suite, API test suite). Use the template in `challenges/challenge-10-tech-sprint/templates/user-story-issue.md`.
