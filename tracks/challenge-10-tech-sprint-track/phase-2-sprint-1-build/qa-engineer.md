...
As features become available, do exploratory testing. File bugs as GitHub Issues using the template in `challenges/challenge-10-tech-sprint/templates/bug-report-issue.md`. Include:
