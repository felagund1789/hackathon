...
3. **Verify logs and health checks** -- Confirm that service logs surface useful output in the terminal. Confirm the CI smoke test is passing in GitHub Actions.
