...
|-------|------|----------|-------------|
| 1 | [Spec to Backlog](challenge-17-spec-to-ship-track/phase-1-backlog.md) | 1.5-2 hours | Build a prompt that converts the spec into structured work items |
| 2 | [Technical Analysis](challenge-17-spec-to-ship-track/phase-2-analysis.md) | 1-1.5 hours | Build a prompt that generates a technical analysis from spec + existing code |
| 3 | [Code Generation](challenge-17-spec-to-ship-track/phase-3-code.md) | 2-2.5 hours | Use Copilot to implement the billing module from the generated stories |
| 4 | [Test Specs and Pipeline](challenge-17-spec-to-ship-track/phase-4-tests-pipeline.md) | 1.5-2 hours | Generate test specifications and a CI pipeline |
